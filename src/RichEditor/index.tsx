import { ContentBlock, Editor, EditorState, Modifier } from 'draft-js';
import React, {
  CSSProperties,
  useCallback,
  useContext,
...
export const RichEditor: RichEditorType = ({
  ...
  const { styleMap, blockRenderMap } = useContext(RichEditorContext);
  ...
  const customStyleFn = useCallback((style: Draft.DraftInlineStyle) => {
